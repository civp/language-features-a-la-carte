...
import features.translator.AssignationsHandler.{makeAssignationsCompact, makeAssignationsExplicit}
import features.translator.NamesFinder.{allModifiedVars, allReferencedNames}
import features.translator.TypeInferrer.tryToInferType
